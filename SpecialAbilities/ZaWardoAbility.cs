...
{
    public class ZaWardoAbility : SpecialAbility
    {
        ...
        public override void PreUpdate()
        {
            ...
            if (!Main.dedServ)
            {
                Filters.Scene["ZaWardo"].GetShader().UseProgress(_currentProgress);
